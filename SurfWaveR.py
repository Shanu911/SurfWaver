...
class Main(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        #self.gridLayout_td = QtWidgets.QVBoxLayout(self.scrollAreaWidgetContents_12)
        #self.gridLayout_td.setContentsMargins(9,9,9,9)
        #self.gridLayout_td.setObjectName("trcCanv_vbLayout")
        #self.traces_Canvlabel = QtWidgets.QLabel(self.traces_Canv)
#
        #self.DisperCurve_Canvas.setWidgetResizable(True)
        #self.gridLayout_dd = QtWidgets.QVBoxLayout(self.scrollAreaWidgetContents_13)
        #self.gridLayout_dd.setContentsMargins(9,9,9,9)
        #self.gridLayout_dd.setObjectName("dispCanv_vbLayout")
        #self.DisperCurve_Canvaslabel = QtWidgets.QLabel(self.DisperCurve_Canvas)
        #self.gridLayout_dd.addWidght
#
        #self.geomCanv.setWidgetResizable(True)
        #self.gridLayout_gd = QtWidgets.QVBoxLayout(self.scrollAreaWidgetContents_5)
        #self.gridLayout_gd.setContentsMargins(9,9,9,9)
        #self.gridLayout_gd.setObjectName("geomCanv_vbLayout")
